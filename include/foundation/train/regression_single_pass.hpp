...
void train_mse_single_pass(graph::CompiledGraph *compiled_graph, std::vector<torch::Tensor> &input,
...
void train_population(std::vector<graph::CompiledGraph *> &population, std::vector<torch::Tensor> &input,
