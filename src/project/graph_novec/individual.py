...
def mutate_individual(individual: Individual):
    ...
    graph_mut_hps = mutate_graph_hps(individual.graph_mut_hps)
...
def recombine_individuals(individual1: Individual, individual2: Individual):
    """Recombine two individuals."""
    graph_mut_hps = recombine_graph_hps(individual1.graph_mut_hps, individual2.graph_mut_hps)
...
def random_individual(init_graph_spec):
    init_hps = random_graph_mut_hps()
